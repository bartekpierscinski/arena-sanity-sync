...
export default {
  ...
  fields: [
    {
      ...
      validation: (Rule) =>
        Rule.unique().error("Channel slugs must be unique."),
    },
    {
      name: "lastSyncDate",
  ...
  // This helps ensure the document 'arenaSyncConfig' can be reliably fetched.
  ...
  initialValue: () => ({
    _id: "arenaSyncConfig", // Ensures a predictable ID for the singleton
    channelSlugs: [],
